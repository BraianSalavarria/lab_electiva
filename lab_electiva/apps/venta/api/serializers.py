...
from apps.venta.models import Venta, ItemVenta, Producto
from datetime import date
from apps.venta.models import RendicionDiaria
...
class VentaSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        """Validar items proporcionados en el request"""
...
class RendicionDiariaSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        """Validar que no exista ya una rendición para el usuario en la fecha actual"""
        request = self.context.get('request')
        if not request:
            return data
